            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('owner.images.update', ['image' => $image->id]) }}" method="POST"
                        ...
                        <div class="-m-2">
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="タイトル" class="leading-7 text-sm text-gray-600">画像タイトル</label>
                                    <input type="text" id="タイトル" name="title"
                    ...
                    <form id="delete_{{ $image->id }}" method="post"
                        ...
                        @method('delete')
                        <div class="p-2 w-full mt-4 flex justify-around">
                            <a href="#" type="button" data-id="{{ $image->id }}" onclick="deletePost(this)"
                                class="text-white
